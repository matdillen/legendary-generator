...
heronames$set = recode(heronames$set,
                       ...
                       "Marvel Studios' Guardians of the Galaxy" = "Guardians of the Galaxy 2",
                       "Doctor Strange and the Shadows of Nightmare" = "Doctor Strange")
...
schemnames %<>% 
  dplyr::rename(id = schemtext)
vilnames %<>% 
  dplyr::rename(id = viltext)
henchnames %<>% 
  dplyr::rename(id = henchtext)
...
write_tsv(tooltext,"tooltext.txt",na="",eol="\r\n",quote="needed")
